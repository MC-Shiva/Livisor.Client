...
namespace Livisor.Shared.DTO
{
    ...
    ///
    /// 音源を持たないクライアントは、受信した瞬間からこの時間だけ待って発火する。
    /// LiveScene は音源の再生位置を使い、曲の先頭からの指定位置で実行する。
    ...
    /// 停止中も <c>ScheduledAction</c> は残るので、
    ...
    public class TransportState
    {
        ...
        /// Playing が true のときだけ実行する。LiveScene は曲の再生位置を基準にする。
        /// 取り消しはこの項目を null にする。
        /// </summary>
        [Key(3)]
